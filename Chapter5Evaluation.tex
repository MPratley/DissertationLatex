...
availability of noisy inputs in a simulated network, the input current of the
pre-synaptic neuron can be drawn from a random distribution, as shown in figure
\ref{fig:PRERES2}. 
...
took shape. This is substantially different my original plan of identifying hard
